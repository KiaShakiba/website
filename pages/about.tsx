		...
		<Layout>
			<Content className={styles.container}>
				...
				<div className={styles.rightContainer}>
					...
					<p>I received my B.A.S.c. in Computer Engineering from the University of Waterloo. During my time here I worked as a software developer for various companies, including Environment Canada, Rogers Media, and IBM Canada.</p>
					<p>I&apos;m passionate about teaching. In 2019, I started an educational technology company, <Link href='https://examify.ca' target='_blank'>Examify Inc.</Link> which focuses on the online evaluation of coding assignments and examinations.</p>
